  ...
  const steps = [
    {
      ...
      description:
        'The "Agent", also known as the "Attorney-in-Fact" is a responsible and trustworthy person such as a relative, friend, lawyer, accountant, or professional.'
    },
    {
      fields: [
        <InputField
      ...
      description:
        "Include the receiving party's full name and address as part of the contact information to be listed on the document. The receiving party is the person or company who is promising not to disclose the confidential information or data that they receive."
    },
    {
      fields: [
        <InputField
        ...
        <InputField
          ...
          field="dispute_reason_in_bullet_list"
        />
      ],
      title: "Lease Types",
      description: `
      ...
      <section className="main_sidesection">
        ...
        <div className="main_container">
          <div className="left_container">
            ...
            <div className="form-section_sub-section-wrapper__28arK">
              <h2>Agent Info</h2>
            </div>
            <form action="">{steps[step].fields.map(field => field)}</form>
            <footer className="form-control-panel_button-panel__34lpp">
              <div>
                <button
                  data-id="back"
                  type="button"
                  className="Button-button-d0484b Button-link-778592"
              ...
              <div className="form-control-panel_button-group__1goiC">
                {step !== steps.length - 1 && (
                  <button
                    ...
                    className="Button-button-d0484b form-control-panel_btn-skip__3zOem Button-medium-afe9a1 Button-link-778592"
                  >
                    Skip
                  </button>
                )}
                {step == steps.length - 1 ? (
                  <button
                    ...
                    className="Button-button-d0484b Button-medium-afe9a1 Button-primary-233931"
                  >
                    Save
                  </button>
                ) : (
              ...
              {downloader && (
                <>
                  <a
                    ...
                    href="https://sandesh9.pythonanywhere.com/api/template/downloadfile/output.pdf/"
                  >
                    Download Pdf
                  </a>
                  ...
                  <a
                    ...
                    href="https://sandesh9.pythonanywhere.com/api/template/downloadfile/output.docx/"
                  >
                    Download Docx
                  </a>
                </>
